...
zillow_path = "./data/zillow/County_zhvi_uc_sfrcondo_tier_0.33_0.67_sm_sa_mon_210526.csv"
...
year_map = {
    ...
    "fred_2021": ["2021-01-31", "2021-02-28", "2021-03-31", "2021-04-30"]
}
...
final["fred_2020"] = final["fred_2019"] * 1.061
# ??? total guess
final["fred_2021"] = final["fred_2020"] * 1.0

for year in year_map:
    for month in year_map[year]:
        final[f"ratio-{month}"] = final[month]/final[year]
